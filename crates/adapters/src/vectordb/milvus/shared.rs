...
pub(super) const DEFAULT_VECTOR_FIELD: &str = "vector";
pub(super) const DEFAULT_SPARSE_FIELD: &str = "sparse_vector";
pub(super) const DEFAULT_COLLECTION_DESCRIPTION: &str = "Semantic code search collection";
pub(super) const DEFAULT_HYBRID_COLLECTION_DESCRIPTION: &str =
    "Semantic code search hybrid collection";

pub(super) const MILVUS_OUTPUT_FIELDS: [&str; 7] = [
    "id",
    "content",
    "relativePath",
    "startLine",
...
pub(super) fn ensure_collection_name(collection: &CollectionName) -> Result<()> {
...
pub(super) fn milvus_in_string(field: &str, values: &[Box<str>]) -> Box<str> {
    let escaped = values
        .iter()
